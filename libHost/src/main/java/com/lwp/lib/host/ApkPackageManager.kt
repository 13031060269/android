...
internal class ApkPackageManager(private val orig: PackageManager, private val apkInfo: ApkInfo) :
    PackageManager() {
    @Throws(NameNotFoundException::class)
    override fun getPackageInfo(packageName: String, flags: Int): PackageInfo {
        return apkInfo.packageInfo
    }
...
//         ApkPlugin.getInstance().getPluginByPackageName(packageName);
    ...
    override fun getPackageGids(packageName: String): IntArray {
        return apkInfo.packageInfo.gids
    }
    ...
    override fun getApplicationInfo(packageName: String, flags: Int): ApplicationInfo {
        return apkInfo.packageInfo.applicationInfo
    }

    @Throws(NameNotFoundException::class)
    override fun getActivityInfo(component: ComponentName, flags: Int): ActivityInfo {
        if (component.packageName == apkInfo.packageName) {
            return hostActivityInfo
        }
        return orig.getActivityInfo(
            component,
            flags
        )
    }
