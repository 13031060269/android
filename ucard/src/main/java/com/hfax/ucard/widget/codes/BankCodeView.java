 ...
 * @author SongGuangYao
 */
public class BankCodeView extends AppCompatTextView {
    ...
    public BankCodeView(Context context) {
        super(context);
        init(context);
    }

    public BankCodeView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public BankCodeView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        setTextColor(context.getResources().getColor(R.color.register_code_color));
    ...
    private void requestCode(String bankCode, String cardNo, String phone, String type) {
        requestCode(bankCode, cardNo, phone, type, null, null);
    }
     ...
     * @param type  验证码类型
     */
    private void requestCode(String bankCode, String cardNo, String phone, String type, String captchaId
            , String captchaText) {
        ...
        final RequestMap map = new RequestMap(NetworkAddress.SMS_BANK_CODE);
        map.put("sms-type", type);
        map.put("mobile", phone);
     ...
     * @param type     类型
     */
    public void requestSmsCode(String bankCode, String cardNo, String phone, String type) {
        ...
        this.cardNo = cardNo;
        requestCode(bankCode, cardNo, phone, type);
    }
