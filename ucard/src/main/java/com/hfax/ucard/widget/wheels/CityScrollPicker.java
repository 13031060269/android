 ...
 */
public class CityScrollPicker extends ScrollPickerView<GlobalConfigBean.CityUnit> {
    ...
    public CityScrollPicker(Context context, AttributeSet attrs) {
    ...
    @Override
    public void drawItem(Canvas canvas, List<GlobalConfigBean.CityUnit> data, int position, int relative, float moveLength, float top) {
        CharSequence text = data.get(position).value;
