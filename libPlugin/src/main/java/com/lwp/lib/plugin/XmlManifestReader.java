...
class XmlManifestReader {
    ...
    public static String getManifestXMLFromAPK(ZipFile file, ZipEntry entry) {
        ...
        try (XmlResourceParser parser = new XmlResourceParser()) {
    ...
    private static float complexToFloat(int complex) {
        return (float) (complex & 0xFFFFFF00) * RADIX_MALTS[(complex >> 4) & 3];
    }

    private static final float[] RADIX_MALTS = {0.00390625F, 3.051758E-005F,
